...
/**
 * A configurable implementation of the {@link com.celebi.framework.dto.converter.business.impl.valueconverter.ValueConverter}
 * interface.
 * <p/>
 * <p>
 ...
 * <p/>
 * <p>
 * <b>Special Converters:</b> Converters that are registered under the properyName that they have in an entity class:
 * 
 * <pre>
...
public class ValueConverterImpl implements ValueConverter
{
	...
	private Map<String, ConverterTemplate> specialConverters; // String is the propertyName, e.g. "firstname"
	private Map<String, ConverterTemplate> defaultConverters; // String is the classname, e.g. "java.lang.String"
	private List<GenericConverterTemplate> genericConverters; // Not registered under a String
