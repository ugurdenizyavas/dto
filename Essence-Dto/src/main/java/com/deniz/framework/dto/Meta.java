 ...
 * <p/>
 * <p>
 * A Meta consist of the actual value of the field plus warning and error messages from the validation of this Meta.
 * <p/>
 * <p/>
 * The flag valueChanged can be used to signal that the value was changed and that readers of Meta objects should update any GUI
 * representation of the value.
 * <p/>
 * <p>
 * Metas follow the <i>Data Transfer Objects</i> design pattern. Compared to the classical <i>DTO</i> pattern, we embed the Metas
 * into the persistent entities. We think this approach makes it much easier to convert the Dto representation to the entity
 * representation especially if you have objects that contain collections and you use inheritance at the same time for these
 * objects.
 * <p/>
 * <p>
 * The use of the DTO pattern is primarily motivated by centralizing all validation logic as a business component. This avoids
 * having some validation logic (String -> Date conversion fails) in the service or presentation layer and other logic like max
 * number of allowed characters as annotation in your entity.
 * <p/>
 * <p>
 * When the value of a Meta is set, some values that are semantically equivalent to <tt>null</tt> like "" are normalized to
 * <tt>null</tt>, see {@link #convertEmpty(String)} for details.
 * <p/>
 * @author Deniz Yavas
 */
public class Meta implements Serializable
{
	 ...
	 * <p>
	 * All errors and warnings will be removed and values that are equivalent to null are normalized (see
	 * {@link #convertEmpty(String)}).
	 * <p>
	 * valueChanged flag is set if the new value differs from the old value
	 * @param newValue the new value of the Meta
	 */
	...
	/**
	 * This method sets the value and the valueChanged flag.
	 * The reason for the value changed flag is at the end that in cos packets values should only be set if they have been
	 * changed. in case of an init value: null should not be added. Therefore we set the valueChanged flag when the default
	 ...
	 * <p/>
	 * <p>
	 * This method converts these values to <tt>null</tt>. All other values remain untouched.
	 * @param value The original value to check for null equivalent values
	 * @return <tt>null</tt> if <tt>null</tt>, "" or the value "empty.none" were given. The original value otherwise.
	 */
	 ...
	 * <p/>
	 * <p>
	 * This method converts removes these values. All other values remain untouched.
	 */
	...
	/**
	 * @deprecated Deprecated because it violates the Java Beans naming conventions. Please use {@link #getHasErrors()}
	 */
	...
	/**
	 * @deprecated Please use the more specific methods like resetErrorsAnWarnings() or reset(boolean, boolean, boolean, boolean)
	 */
	public void reset()
	{
		resetErrorsAndWarnings();
	 ...
	 * @param value if true, value is set to null
	 * @param valueChanged if true, valueChanged is set to false
	 * @param errors if true, all errors are removed
	 * @param warnings if true, all warnings are removed
	 */
	...
	/**
	 * Sets the value of the meta to the value of the given meta.
	 * <b> All Errors and Warnings will be removed </b>
	 * @param value the Meta with the new value for this meta
	 */
	...
	{
		return "Meta{" + "valueMode=" + valueMode + ", value=" + value + ", valueList=" + valueList + ", valueChanged=" + valueChanged + ", locked="
				+ locked + ", lockedChanged=" + lockedChanged + ", warnings=" + getNumberOfWarnings() + ", errors=" + getNumberOfErrors() + '}';
	}
